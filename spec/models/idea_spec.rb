...
describe Idea do
  it "should properly classify long expired ideas" do
    fresh_idea = Factory.create(:idea)
    week_old_scratched_idea = Factory.create(:idea, :updated_at => 1.1.weeks.ago, :scratched => true)
  
    month_old_active_idea = Factory.create(:idea)
    month_old_scratched_idea = Factory.create(:idea, :updated_at => 1.month.ago, :scratched => true)
    
    year_old_active_idea = Factory.create(:idea, :updated_at => 1.year.ago)
    year_old_scratched_idea = Factory.create(:idea, :updated_at => 1.year.ago, :scratched => true)
